...
public class JsonContainerFactoryTest
{
    ...
    public void test2()
    {
        ...
        assertEquals(new Student(1001, "com", List.of(10, 20, 30)), c17.get(0));
    ...
    public void test3()
    {
        ...
        assertEquals(List.of("hello", "powerful", "com", "container", "!"), c6);
